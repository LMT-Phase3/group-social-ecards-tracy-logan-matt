      ...
      <div style={{ border: 'solid 2px black', borderRadius: '8px' }} className='card-detail-all'>
        ...
        <div className='create-card-dropdown flex'>
          ...
          >
            ...
            <Dropdown.Item style={{ color: '#ffcd24' }} eventKey='#ffcd24'>Gold</Dropdown.Item>
            <Dropdown.Item style={{ color: '#2aabe4' }} eventKey='#2aebe4'>Light Blue</Dropdown.Item>
            <Dropdown.Item style={{ color: '#9dc8e4' }} eventKey='#9dc8e4'>Sky</Dropdown.Item>
            <Dropdown.Item style={{ color: '#666b6e' }} eventKey='#666b6e'>Gray</Dropdown.Item>
            <Dropdown.Item style={{ color: '#ffc2bb' }} eventKey='#ffc2bb'>Pink</Dropdown.Item>
          </DropdownButton>
          <DropdownButton
            className='levels'
            alignRight
          ...
          >
            ...
            <Dropdown.Item style={{ border: 'solid 5px #ffcd24' }} eventKey='#ffcd24'>Gold</Dropdown.Item>
            <Dropdown.Item style={{ border: 'solid 5px #2aabe4' }} eventKey='#2aebe4'>Light Blue</Dropdown.Item>
            <Dropdown.Item style={{ border: 'solid 5px #9dc8e4' }} eventKey='#9dc8e4'>Sky</Dropdown.Item>
            <Dropdown.Item style={{ border: 'solid 5px #666b6e' }} eventKey='#666b6e'>Gray</Dropdown.Item>
            <Dropdown.Item style={{ border: 'solid 5px #ffc2bb' }} eventKey='#ffc2bb'>Pink</Dropdown.Item>
          </DropdownButton>
          <DropdownButton
            className='levels'
            alignRight
