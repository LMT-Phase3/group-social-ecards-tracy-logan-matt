...
const CardList = ({ token, username, isCreating, setIsCreating, apiPath, myProfile, setMyProfile, myFavorites, setMyFavorites, handleUnFollow, handleFollow, handleFavorite, handleUnFavorite }) => {
